...
public interface List<T> {
     ...
     * @return Object objeto
     */
    public T getPrevious(LinkedListNodeDoble node);
    ...
    T getPrevious(LinkedListNodeDoble node);

    T getPrevious(LinkedListDoble node);

    T getNext(LinkedListNodeDoble node);
